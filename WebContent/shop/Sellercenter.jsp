...
文件名称：Sellercenter.jsp
文件标识：详见校园二手交易系统设计说明书
摘         要：本文件完成的主要功能是实现卖家中心的显示
...
<body style="background: url(img/s_login.jpg);background-size: cover;" background-size: cover;">
<%
...
<iframe src="head.jsp" style="width:100%; height: 50px; display: block;" frameborder="0" scrolling="no"></iframe>
        ...
        <div class="col-md-offset-3 col-md-6">
            <form class="form-horizontal" method="post" name="login" action="../loginServlet">
                <span class="heading">卖家中心</span>
                	<div class="form-group">
                    	
                	</div>
                	
                	<div class="form-group">
                    <!--	<button type="button" class="btn btn-success" onclick="window.location.href='Seller.jsp'" >个人中心</button>-->
                   <a href="Seller.jsp"> <img src="img/conf/Seller.png" style="width:100px"></a>
                    	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    	
                    <a href="SellerAdd.jsp"><img src="img/conf/add.png" style="width:90px"></a> 
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    
                    <a href="Orders.jsp"><img src="img/conf/orders.png" style="width:100px"></a>
                	</div>
                	<div class="form-group">
                	个人中心 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                	商品添加&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
