...
文件名称：buyercenter.jsp
文件标识：详见校园二手交易系统设计说明书
摘         要：本文件完成的主要功能是实现买家中心界面的显示
...
<body style="background: url(img/login.jpg);background-size: cover;" background-size: cover;">
<%
...
<iframe src="head.jsp" style="width:100%; height: 50px; display: block;" frameborder="0" scrolling="no"></iframe>
        ...
        <div class="col-md-offset-3 col-md-6">
            <form class="form-horizontal" method="post" name="login" action="../loginServlet">
                <span class="heading">买家中心</span>
                	<div class="form-group">
                    	
                	</div>
                	
                	<div class="form-group">
                    	 <a href="shopping.jsp"> <img src="img/conf/shoppingcart.png" style="width:100px"></a>
                    	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    	<a href="b_Orders.jsp"><img src="img/conf/orders.png" style="width:100px"></a>
                	</div>
                	<div class="form-group">
                	&nbsp;&nbsp;&nbsp;&nbsp;
                	购物车&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
