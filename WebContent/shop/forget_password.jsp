...
<canvas></canvas>
    ...
    <form action="../sendemail" method="get">
        ...
        <div class="group-ipt email">
                <input type="text" value="" name="email" id="email" class="ipt" placeholder="请输入邮箱：" required></div>
                 </div>
        <div class="button">
        <button type="submit" class="login-btn register-btn" id="button">发送邮件</button>
            </a></div>
            </form>
            </div>
        <div class="footer">
